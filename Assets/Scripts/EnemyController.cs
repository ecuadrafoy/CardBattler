...
public class EnemyController : MonoBehaviour
{
    ...
    private List<SOCard> cardsInHand = new List<SOCard>();
    ...
    IEnumerator EnemyActionCo()
    {
        ...
        SOCard selectedCard = null;
        int iterations = 0;
        List<CardPlacePoint> preferredPoints = new List<CardPlacePoint>();
        List<CardPlacePoint> secondaryPoint = new List<CardPlacePoint>();
        ...
        switch (enemyAIType)
        {
            ...
            case AIType.handDefensive:
                ...
                iterations = 50;
                while (selectedCard != null && iterations > 0 && (preferredPoints.Count + secondaryPoint.Count > 0))
                {
                    // pick a point to use
    ...
    public void PlayCard(SOCard cardSO, CardPlacePoint placePoint)
    {
        Card newCard = Instantiate(cardToSpawn, cardSpawnPoint.position, cardSpawnPoint.rotation);
    ...
    SOCard SelectedCardToPlay()
    {
        SOCard cardToPlay = null;

        List<SOCard> cardsToPlay = new List<SOCard>();
        foreach (SOCard card in cardsInHand)
        {
